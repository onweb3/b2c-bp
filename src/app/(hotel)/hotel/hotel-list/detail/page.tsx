...
const ListingStayDetailPage: FC<ListingStayDetailPageProps> = ({}) => {
  ...
  return (
    <div className="nc-ListingStayDetailPage container mb-10">
      {/*  HEADER */}
      <header className="rounded-md sm:rounded-xl">
        <div className="relative grid grid-cols-3 md:grid-cols-4 gap-1 md:gap-2">
          <div
          ...
          {PHOTOS.filter((_, i) => i >= 1 && i < 3).map((item, index) => (
            ...
            >
              <div className="aspect-w-5 aspect-h-3 sm:aspect-w-6 sm:aspect-h-5">
                <Image
                  fill
                  className="object-cover rounded-md sm:rounded-xl "
                  src={item || ""}
