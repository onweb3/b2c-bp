...
const ModalSignUp: FC<PageSignUpProps> = ({ }) => {
        ...
        <div className="max-w-md mx-auto space-y-6 ">
          ...
          <form className="grid grid-cols-1 gap-6">
            ...
            <div className="">
              ...
              /> */}
                ...
                <select
                  ...
                  id="countries" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-xl focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            ...
            <label className="block">
              ...
              <span className="text-[9px]">Password must be strong. At least one alphabet. At least one digit. At least one special character.</span>
              <Input
          ...
          <ButtonPrimary className="w-full" onClick={signupProcess}>Continue</ButtonPrimary>
