                ...
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-700">
                  <div className="relative flex flex-col px-5 py-6 space-y-5">
                    <Checkbox
                      ...
                      onChange={(checked) =>
                        handleChangeAirlines(checked.target.checked, "All Airlines")
                      }
                    />
                    <hr />
                    {typeOfAirlines.map((item) => (
                      <div key={item.name} className="">
                        <Checkbox
                          ...
                          onChange={(checked) =>
                            handleChangeAirlines(checked.target.checked, item.name)
                          }
                        />
                      </div>
                    ))}
                    ...
                    {stopPoints.map((item) => (
                      <div key={item.name} className="">
                        <Checkbox
                          ...
                          onChange={(checked) =>
                            handleChangeStopPoint(checked.target.checked, item.name)
                          }
                        />
                      </div>
                    ))}
