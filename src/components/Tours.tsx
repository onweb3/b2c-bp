...
import TourCard from './Attraction/TourCard';
...
export default function Tours({
    heading = "Tours",
    subHeading = "Escape the ordinary and embark on a remarkable journey with our incredible International Tour Packages!",
    className = "",
    itemClassName = "",
    data,
    itemPerRow = 5,
                    ...
                    <AnimatePresence initial={false} custom={direction}>
                        ...
                        {data?.map((item, indx) => (
                            ...
                            >
                                   ...
                                   <TourCard key={item?._id} packageItem={item}/>
                            </motion.li>
                        ))}
