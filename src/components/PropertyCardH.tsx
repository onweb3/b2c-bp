...
const HotelCardH: FC<PropertyCardHProps> = ({
  className = "",
  data = DEMO_DATA,
}) => {
  const {
    ...
    return (
      <div className="flex-shrink-0 p-3 w-full sm:w-64 ">
        <GallerySlider
          ...
          href={"/hotel/hotel-list/detail" as Route}
        />
        ...
        <div className="space-y-4 w-full">
          <div className="inline-flex space-x-3">
            ...
            />
             ...
             {isAds && <Badge name="Coupon Code" color="green" />}
          </div>
          <div className="flex items-center space-x-2">
  ...
  return (
    ...
    >
      <Link href={"/hotel/hotel-list/detail" as Route} className="absolute inset-0"></Link>
