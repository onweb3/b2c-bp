...
export default function GallerySlider({
  ...
  let currentImage = ""
  let currentImageCheck = images[index]
  let typo = typeof currentImageCheck

  if (currentImageCheck instanceof Object) {
    if (currentImageCheck.isRelative) {
      currentImage = `${config?.NEXT_PUBLIC_CDN_URL + currentImageCheck.path} `
    } else {
      currentImage = currentImageCheck.path
    }
  } else if (typo == "string") {
    if (currentImageCheck.startsWith("/public/images")) {
      currentImage = `${config?.NEXT_PUBLIC_CDN_URL + currentImageCheck} `
    } else {
      currentImage = currentImageCheck
    }
  }
