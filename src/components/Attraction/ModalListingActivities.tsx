...
interface ModalListingActivitiesProps {
  renderChildren?: (p: { openModal: () => void }) => React.ReactNode;
  activities: ActivityExcursion[]
}

const ModalListingActivities: FC<ModalListingActivitiesProps> = ({ renderChildren, activities }) => {
                    ...
                    <div className="flex-1 pt-12 p-1 flex flex-col overflow-auto">
                      <div className="flex-1 flex flex-col bg-white dark:bg-neutral-800">
                        <div className="flex-1 flex flex-col transition-opacity animate-[myblur_0.4s_ease-in-out] overflow-auto">
                          ...
                          <div className="flex-1 relative flex z-10 w-full p-4">
                            {activities?.length ? (
...
export default ModalListingActivities;
